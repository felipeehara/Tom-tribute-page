...
export const Menu: React.FC<menuProps> = (mt) => {
  ...
  const [isOpen, setIsOpen] = useState(false); // Novo estado
  ...
  return (
    <div className='fixed md:static transition-opacity'>
      ...
      <div className='w-10 absolute'>
        ...
        <div
          ref={menu}
          className={`transform transition-transform duration-300 ease-in-out fixed h-screen w-64 bg-gradient-to-t from-black to-gray-400 top-0 left-0 pt-8 
